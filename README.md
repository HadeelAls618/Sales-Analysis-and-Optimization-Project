...
- **Sales Dashboard**: Developed a dashboard in Tableau to visualize key performance indicators (KPIs) and sales trends in a user-friendly format, enabling stakeholders to make data-driven decisions
